...
EverythingPath := "C:\Program Files\Everything 1.5a\Everything64.exe"       ;If your everything.exe isn't here, fix that. Keep the quotes.
MyUsername := "Andriesu"           ;Go to %userprofile% and change this to the title of that window. Keep the quotes.
